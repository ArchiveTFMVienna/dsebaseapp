...
declare 
    %rest:GET
    %rest:path("/rundbriefe-app/api/about")
...
function api:api-about($format as xs:string*, $pageNumber as xs:integer*, $pageSize as xs:integer*) {
    let $endpoints := 
        <result>
            <ep>
                <url>/rundbriefe-app/api/collections</url>
            ...
            <ep>
                <url>{"/rundbriefe-app/api/collections/{$collection}"}</url>
...
declare 
    %rest:GET
    %rest:path("/rundbriefe-app/api/collections")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/rundbriefe-app/api/collections/{$collection}")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare
    %rest:GET
    %rest:path("/rundbriefe-app/api/entities")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/rundbriefe-app/api/collections/{$collection}/{$id}")
...
declare
    %rest:GET
    %rest:path("/rundbriefe-app/api/entities/{$id}")
...
declare
    %rest:GET
    %rest:path("/rundbriefe-app/api/entity-types")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/rundbriefe-app/api/entity-types/{$id}")
